  ...
  (
    ...
    return (
      ...
      >
        ...
        <div className="relative  w-full md:w-5/12 ml-auto mr-auto">
          {open && (
            <CommandList
              className="absolute top-1 z-10 text-center w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
